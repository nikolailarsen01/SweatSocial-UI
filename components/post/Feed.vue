...
<template>
  <div class="bg-white border rounded-sm max-w-2xl mb-2">
    ...
    <img :src="post.img || 'https://uploads-ssl.webflow.com/6215fd1fb17db136a4a1c6fd/62556077b7870d1f35df0ee3_dall-e-billede-open-ai-10.jpeg'" class="object-cover w-[1000px]" />
